...
class Primitive(object):
    ...
    level_polarity : string
        ...
        a "positive" primitive, i.e. indicating where copper should remain,
...
class Line(Primitive):
    ...
    def __init__(self, start, end, aperture, level_polarity='dark', **kwargs):
    ...
    def __str__(self):
        return "<Line {} to {} [{}]>".format(self.start, self.end, self.units)
...
class Arc(Primitive):
    ...
    def __init__(self, start, end, center, direction, aperture, quadrant_mode, level_polarity='dark', **kwargs):
    ...
    def __str__(self):
        return "<Arc  {} to {} ({}, {}) {} [{}]>".format(self.start, self.end, self.start_angle, self.end_angle,
                                                         self.direction, self.units)
...
class Circle(Primitive):
    ...
    def __init__(self, position, diameter, hole_diameter=None, hole_width=0, hole_height=0, level_polarity='dark', **kwargs):
    ...
    def equivalent(self, other, offset):
        '''Is this the same as the other circle, ignoring the offset?'''
    ...
    def __str__(self):
        _hole_diameter = self.hole_diameter
        if _hole_diameter is None:
            _hole_diameter = 0
        return '<Circle (%f, %f) (%f, %f), (%f, %f) [%s]>' \
               % (self.diameter, _hole_diameter, self.position[0], self.position[1],
                  self.hole_width, self.hole_height, self.units)


class Ellipse(Primitive):
    """
    """
    def __init__(self, position, width, height, level_polarity='dark', **kwargs):
...
class Rectangle(Primitive):
    ...
    def __init__(self, position, width, height, hole_diameter=0, hole_width=0, hole_height=0, level_polarity='dark', **kwargs):
    ...
    def __str__(self):
        return "<Rectangle W {} H {} R {} [{}]>".format(self.width, self.height, self.rotation * 180/math.pi, self.units)
...
class ChamferRectangle(Primitive):
    """
    """
    def __init__(self, position, width, height, chamfer, corners=None, level_polarity='dark', **kwargs):
...
class RoundRectangle(Primitive):
    ...
    def __init__(self, position, width, height, radius, corners, level_polarity='dark', **kwargs):
...
class Polygon(Primitive):
    ...
    """
    def __init__(self, position, sides, radius, hole_diameter=0, hole_width=0, hole_height=0, level_polarity='dark', **kwargs):
...
class AMGroup(Primitive):
    """
    """
    def __init__(self, amprimitives, stmt=None, level_polarity='dark', **kwargs):
        """

        stmt : The original statement that generated this, since it is really hard to re-generate from primitives
        """
        ...
        for amprim in amprimitives:
            ...
            if isinstance(prim, list):
                ...
                prim.level_polarity = self.level_polarity
    ...
    #         _string += p.__str__()+'\n'
    #     return '<AMGroup with %d primitives:\n%s>' % (len(self.primitives), _string)
...
class Outline(Primitive):
    ...
    def __init__(self, primitives, level_polarity='dark', **kwargs):
    ...
    #     for p in self.primitives:
    #         _string += p.__str__()+'\n'
    #     return '<Outline with %d primitives:\n%s>' % (len(self.primitives), _string)
...
class RoundButterfly(Primitive):
    ...
    def __init__(self, position, diameter, level_polarity='dark', **kwargs):
...
class SquareButterfly(Primitive):
    ...
    def __init__(self, position, side, level_polarity='dark', **kwargs):
...
class Donut(Primitive):
    ...
    def __init__(self, position, shape, inner_diameter, outer_diameter, level_polarity='dark', **kwargs):
...
class SquareRoundDonut(Primitive):
    ...
    def __init__(self, position, inner_diameter, outer_diameter, level_polarity='dark', **kwargs):
...
class Drill(Primitive):
    ...
    def __str__(self):
        return '<Drill %f (%f, %f) [%s]>' % (self.diameter, self.position[0], self.position[1], self.units)


class Slot(Primitive):
    """ A drilled slot
    """
    def __init__(self, start, end, diameter, level_polarity='dark', **kwargs):
    ...
    def __str__(self):
        return '<Slot (%f, %f) (%f, %f) %f [%s]>' % (self.start[0], self.start[1], self.end[0], self.end[1], self.diameter, self.units)
